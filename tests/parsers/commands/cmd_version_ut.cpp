...
TEST(cmd_version_ut, cmd_pcode_version_ok)
{
...
TEST(cmd_version_ut, cmd_pcode_version_fail)
{
	const std::string test_string {
		"PCODE: \r\n"
	};
...
TEST(cmd_version_ut, cmd_pcode_version_token_fail)
{
	const std::string test_string {
		"PODE: 300c\r\n"
	};
...
TEST(cmd_version_ut, cmd_fw_version_ok)
{
...
TEST(cmd_version_ut, cmd_fw_version_fail)
{
	const std::string test_string {
		"FVER: \r\n"
	};
...
TEST(cmd_version_ut, cmd_fw_version_token_fail)
{
	const std::string test_string {
		"HVER: 2.4\r\n"
	};
...
TEST(cmd_version_ut, cmd_hw_version_ok)
{
...
TEST(cmd_version_ut, cmd_hw_version_fail)
{
	const std::string test_string {
		"HVER: \r\n"
	};
...
TEST(cmd_version_ut, cmd_hw_version_token_fail)
{
	const std::string test_string {
		"FVER: 1.0\r\n"
	};
...
TEST(cmd_version_ut, cmd_man_code_version_ok)
{
...
TEST(cmd_version_ut, cmd_man_code_version_fail)
{
	const std::string test_string {
		"MANCODE: \r\n"
	};
...
TEST(cmd_version_ut, cmd_man_code_version_token_fail)
{
	const std::string test_string {
		"MANODE: 30\r\n"
	};
